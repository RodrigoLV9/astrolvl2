...
<BlogImage src={img1} alt={"Codigo web estructurado combinado con grafico de crecimiento SEO"} />
...
<BlogImage src={img2} alt={"Usuario frustrado frente a laptop con carrito digital en pantalla"} />
