...
<BlogImage src={img1} alt={"Llave metalica sobre mesa de vidrio representando propiedad digital"} />
...
<BlogImage src={img2} alt={"Candado metalico sobre teclado simbolizando seguridad SSL"} />
