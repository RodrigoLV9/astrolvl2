...
<BlogImage src={img1} alt={"Carriles digitales de alta velocidad representando rendimiento web"} />
...
<BlogImage src={img2} alt={"Mano sosteniendo smartphone con checkout completado"} />
...
<BlogImage src={img3} alt={"Carrito de compras con escudo de seguridad digital"} />
