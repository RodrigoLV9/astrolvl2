...
<BlogImage src={img1} alt={"Gráfico holográfico de crescimento exponencial na mesa corporativa"} />
...
<BlogImage src={img2} alt={"Mapa mundial com nós luminosos representando distribuição de dados"} />
